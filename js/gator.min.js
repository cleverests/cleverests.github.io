...
(function () {
  function t(a) {
    return k
      ...
      ? (k = a.webkitMatchesSelector)
      : a.mozMatchesSelector
      ? (k = a.mozMatchesSelector)
      : a.msMatchesSelector
      ? (k = a.msMatchesSelector)
      : a.oMatchesSelector
      ? (k = a.oMatchesSelector)
      : (k = e.matchesSelector);
  }
  function q(a, b, c) {
    if ("_root" == b) return c;
  ...
  function w(a, b, c) {
    if (d[a][c]) {
      ...
      m = 0;
      for (f in d[a][c])
        d[a][c].hasOwnProperty(f) &&
          (g = q(k, f, l[a].element)) &&
          e.matchesEvent(c, l[a].element, g, "_root" == f, b) &&
          (m++, (d[a][c][f].match = g), (h[m] = d[a][c][f]));
  ...
  function r(a, b, c, k) {
    ...
    if (this.element) {
      ...
      for (h = 0; h < a.length; h++)
        k
          ? v(this, a[h], b, c)
          : ((d[g] && d[g][a[h]]) || e.addEvent(this, a[h], f(a[h])),
            u(this, a[h], b, c));
      return this;
    }
  }
  function e(a, b) {
    if (!(this instanceof e)) {
      for (var c in l) if (l[c].element === a) return l[c];
      p++;
      l[p] = new e(a, p);
      return l[p];
    }
